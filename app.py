from flask import Flask, redirect, render_template, request, url_for, make_response, flash, Response
...
def index():
    ...
    salary_str = (request.args.get('salary') or '').strip()
...
def add():
    ...
    try:
        ...
        flash("Amount must be a valid positive number.")
        return redirect(url_for('index'))
